...
// import CreateModal from './list/components/CreateModal';
    ...
    <PageContainer isLoading={isFetching} insertProps={{ px: [5, '48px'] }}>
      <Flex pt={[4, '30px']} alignItems={'center'} justifyContent={'space-between'}>
        <Flex flex={1} alignItems={'center'}>
          <Image src={'/imgs/module/explore.png'} alt={''} mr={2} h={'24px'} />
      ...
      >
        {myApps
          // .filter((app) => app.isShow === ModelType.EXPLORE)
          .map((app) => (
            <MyTooltip
              key={app._id}
              ...
              <Box
                ...
                onClick={() => {
                  if (userInfo?.team.canWrite) {
                    router.push(`/explore/detail?appId=${app._id}`);
                  } else {
